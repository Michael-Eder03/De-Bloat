...
if ($manufacturer -like "*HP*") {
    ...
    if (Test-Path -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\HP Documentation") { Remove-Item -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\HP Documentation" -Recurse -Force }
    ...
    if (test-path -Path 'C:\Program Files (x86)\InstallShield Installation Information\{6468C4A5-E47E-405F-B675-A70A70983EA6}\setup.exe') {
        invoke-webrequest -uri "https://github.com/Michael-Eder03/De-Bloat/blob/main/HPConnOpt.iss" -outfile "C:\Windows\Temp\HPConnOpt.iss"
...
if (test-path -Path 'C:\Program Files\HP\Z By HP Data Science Stack Manager\Uninstall Z by HP Data Science Stack Manager.exe') {
    ...
    if (Test-Path -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\HP Sure Click Pro Secure Browser.lnk" -PathType Leaf) { Remove-Item -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\HP Sure Click Pro Secure Browser.lnk" -Force }
...
if ($mcafeeinstalled -eq "true") {
    ...
    # Download Source
    $URL = 'https://github.com/Michael-Eder03/De-Bloat/blob/main/mcafeeclean.zip'
    ...
    write-output "Downloading McAfee Removal Tool"
    # Download Source
    $URL = 'https://github.com/Michael-Eder03/De-Bloat/blob/main/mccleanup.zip'
