...
.NOTES
  ...
  Change: 08.01.2026 - Changed Uninstall Logic of Manufacture Apps
...
if ($manufacturer -like "*HP*") {
    ...
    if (test-path -Path 'C:\Program Files (x86)\InstallShield Installation Information\{6468C4A5-E47E-405F-B675-A70A70983EA6}\setup.exe') {
        invoke-webrequest -uri "https://raw.githubusercontent.com/Michael-Eder03/De-Bloat/main/HPConnOpt.iss" -outfile "C:\Windows\Temp\HPConnOpt.iss"
...
if (test-path -Path 'C:\Program Files\HP\Z By HP Data Science Stack Manager\Uninstall Z by HP Data Science Stack Manager.exe') {
    ...
    if (Test-Path -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\HP_Documentation") { Remove-Item -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\HP_Documentation" -Force }
